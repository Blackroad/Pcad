def test_t001(app):
    ...
    assert app.element_presented(dashboard="//table[@class='allDocumentsTable']",
    ...
    headers_from_publish_table = [i.text for i in (app.wd.find_elements_by_xpath("//fieldset[@class='publishedDocumentsCont'][1]//th[text()]"))]
    ...
    assert app.element_presented(docwriter="//div[@id = 'navigationBar']") is True  # verify that docwriter is opened
